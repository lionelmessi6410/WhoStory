...
var language = {
    en: {
        ...
        step5: "FINAL STEP:<br>Decide whether you want to send a friend request in 5 days. If you become friends, you can continue chatting and see profiles of each other. Otherwise all messages will be deleted and you will meet her/him again.",
        whoStoryPlus: "<strong>$0.99 / month</strong> &mdash; after downloading <span class=\"logo\">WhoStory</span> from Apple App Store or Google Play, you can decide whether you want to pay for <span class=\"logo\">WhoStory Plus+</span>. Once you buy it, you can send 30 letters everyday, and you are able to set as many filters as you want. Last but not least, your messages will be reserve for 5 more days, which means you will have more time to decide if you want to become friends with the pen pal. Trust us, it's worthy!</p>",
