...
var language = {
    en: {
        ...
        contentWhy2: "<span class=\"logo\">WhoStory</span>, another chance for you, to share your story to someone you never met.</p>",
        step1: "STEP 1:<br>3 letters / day. You have 3 chances to send letters to someone you never met.",
        step2: "STEP 2:<br>Set up to 3 filters, and you will receive 3 letters based on your expectations.",
        step3: "STEP 3:<br>Choose the letter you are interested in, and reply. You can reply all or none of them. It doesn't matter.",
        step4: "STEP 4:<br>Chat anonymously for 5 days. Under this mode, you won't know each other.",
        step5: "FINAL STEP:<br>Decide weather you want to send a friend request in 5 days. If you become friends, you can continue chatting and see profiles of each other. Otherwise all messages will be deleted and you will meet her/him again.",
        whoStoryPlus: "<strong>$0.99 / month</strong> &mdash; after downloading <span class=\"logo\">WhoStory</span> from Apple App Store or Google Play, you can decide weather you want to pay for <span class=\"logo\">WhoStory Plus+</span>. Once you buy it, you can send 30 letters everyday, and you are able to set as many filters as you want. Last but not least, your messages will be reserve for 5 more days, which means you will have more time to decide if you want to become friends with the pen pal. Trust us, it's worthy!</p>",
    ...
    tw: {
        ...
        step1: "STEP 1:<br>每天有三封信的機會，能夠和三位你不曾遇過的人，分享屬於自己的故事。",
        step2: "STEP 2:<br>設置過濾器來接收你希望收到的故事類型，每位使用者每天都會收到三封信。",
        step3: "STEP 3:<br>在收到的三封信中，選擇有興趣的故事並回應給你的筆友。當然，你也可以什麼都不選。",
        step4: "STEP 4:<br>現在你和你的筆友有五天的時間能夠聊著屬於你們的故事，在這期間你們不會知道對方的身份。",
        step5: "FINAL STEP:<br>你們必須在五天內決定是否要送好友邀請給你的筆友。如果成為朋友，你們可以持續跟彼此聊天並得知對方的真實身分。如果沒有在五天內成為朋友，那麼之前所有的聊天記錄將被刪除，未來也沒有機會再遇見對方",
